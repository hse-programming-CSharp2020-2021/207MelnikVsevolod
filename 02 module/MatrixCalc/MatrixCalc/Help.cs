...
namespace MatrixCalc
{
    partial class Program
    {
        ...
        static void Help()
        {
            ...
            Console.WriteLine("  Чтобы добавить матрицу в память используйте команды read, file или rand.");
            Console.WriteLine("  <матрица> - номер матрицы в памяти или new для создания новой.");
            Console.WriteLine("  Пример: new = 5 + 8 - сложить 5-ю и 8-ю матрицы и записать результат в новую матрицу.");
            Console.WriteLine("  Пример: 2 = 0 * 3 - умножить 0-ю и 3-ю матрицы и записать результат во 2-ю матрицу.");
            ...
            Console.WriteLine("  <матрица> = <матрица> - скопировать матрицу.");
